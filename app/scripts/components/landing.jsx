...
var JumboTron = React.createClass({
  render: function(){
    return (
      <div className="jumbotron text-center jumboHeight">
        <h1>Shelf</h1>
        <p>A simple app to track homeruns caught by fans.</p>
        <a href="#article" role="button" className="btn btn-default">Learn More</a>
      </div>
    )
  }
});
    ...
    return (
      <div className="row articleContent">
        <div className="col-md-6 col-md-offset-3 ">
          <h1 id="article" className="text-center">The Fan Who Caught A Rod's 3,000th Hit</h1>
          <div className="row">
            <div className="col-md-6 articleParagraphs">
              ...
              <br />
              <img src={"http://assets.nydailynews.com/polopoly_fs/1.2280443.1435937849!/img/httpImage/image.jpg_gen/derivatives/article_1200/rod-3000th-hit-souvenir-baseball.jpg"} alt="A Rod's 3000th hit" className="img-rounded" />
            </div>
            <div className="col-md-6 articleParagraphs">
